...
# Modifier2: Anditya Sridamar Pratyasta, anditya.sridamar.p@kangwon.ac.kr
...
def cmd_callback(data):
  ...
  if message_type == 'ackermann_drive':
    ...
    rospy.loginfo("Linear %s, Angular %s", v, data.angular.z)
    rospy.loginfo("Lnear %s, Steering %s", v, steering) 
